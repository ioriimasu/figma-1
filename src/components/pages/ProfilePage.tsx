...
import profileImage from "figma:asset/5e84f5817825ff9f58a6d8a5688cae0c73480fba.png";
            ...
            <Card className="bg-slate-800/50 backdrop-blur-sm border-slate-700/50 p-8">
              ...
              <div className="space-y-4">
                {achievements.map((achievement, index) => (
                  <div key={index} className="flex items-center justify-between p-4 bg-slate-700/30 rounded-lg border border-slate-600/30 hover:border-[#00BFA6]/30 transition-all duration-300">
                    <div>
