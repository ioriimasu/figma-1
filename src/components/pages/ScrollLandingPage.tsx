...
import { useScrollProgress, useScrollTrigger, useParallax, useHorizontalScroll } from '../hooks/useScrollEffects';
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-slate-300 text-sm leading-relaxed">
                  Multi-layered background elements move at different speeds creating depth. Textile patterns use transform: translateY with varying multipliers.
                </p>
              </div>
            </div>
          </Card>
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-slate-600 mb-8 max-w-2xl mx-auto leading-relaxed">
              Empowering teams to create extraordinary products through innovative technology 
          ...
          <Card className="p-4 bg-slate-800/90 backdrop-blur-md border-teal-400/30 shadow-xl max-w-80">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-slate-300 text-sm leading-relaxed">
                  Cards animate in when entering viewport using Intersection Observer. Staggered delays create premium effect.
                </p>
              </div>
            </div>
          </Card>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              { icon: Shield, title: 'Enterprise Security', description: 'Bank-grade security protocols and compliance' },
              { icon: Rocket, title: 'Scalable Infrastructure', description: 'Grows with your business from startup to enterprise' },
  ...
  const testimonials = [
    {
      ...
      content: 'This platform has revolutionized how our team approaches development. The productivity gains are remarkable.',
      rating: 5
    },
    {
